  ...
  <section class="px-4">
    <div class="flex justify-center mt-[112px] items-start">
      ...
      <div class="text-center">
        <h2 class="text-[#1A2B4B] text-2xl md:text-3xl max-[376px]:text-[18px] ">Решение: <span class="text-[#1D65C1] block md:inline-block"> Единое корпоративное приложение</span>
        </h2>

        <p class="text-[#5F738C] max-[376px]:text-[16px] md:text-lg mt-2">
          Все инструменты для сотрудников в одном месте
        </p>
      </div>
